/*
 * grunt-schepp-angular-template-inline-js
...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('schepp_angular_template_inline_js', 'A grunt task runner for angular-template-inline-js', function() {
